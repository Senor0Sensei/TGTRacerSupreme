...
public:
    ...
    // Drawing Functions
    void DrawPixel(int x, int y, int a);
    void DrawHorizontalLine(int y, int x1, int x2, int a);
    void DrawVerticalLine(int x, int y1, int y2, int a);
    void DrawLine(int x1, int y1, int x2, int y2, int a);
    void DrawRectangle(int x, int y, int width, int height, int a);
    void FillRectangle(int x, int y, int width, int height, int a);
    void DrawCircle(int x0, int y0, int r, int a);
    void FillCircle(int x0, int y0, int r, int a);

    // Write information at a specific Pixel on the screen
    void WriteAt(const char *str, int x, int y, int a);
    void WriteAt(std::string str, int x, int y, int a);
    void WriteAt(int i, int x, int y, int a);
    void WriteAt(float f, int x, int y, int a);
    void WriteAt(double d, int x, int y, int a);
    void WriteAt(bool b, int x, int y, int a);
    void WriteAt(char c, int x, int y, int a);

    // Write to Row, Column

    void WriteRC(const char *str, int row, int col, int a);
    void WriteRC(int i, int row, int col, int a);
    void WriteRC(float f, int row, int col, int a);
    void WriteRC(double d, int row, int col, int a);
    void WriteRC(bool b, int row, int col, int a);
    void WriteRC(char c, int row, int col, int a);

    // Write to the screen
    void Write(const char *str, int a);
    void Write(int i, int a);
    void Write(float f, int a);
    void Write(double d, int a);
    void Write(bool b, int a);
    void Write(char c, int a);

    // Write to the screeen and advance to next line
    void WriteLine(const char *str, int a);
    void WriteLine(std::string str, int a);
    void WriteLine(int i, int a);
    void WriteLine(float f, int a);
    void WriteLine(double d, int a);
    void WriteLine(bool b, int a);
    void WriteLine(char c, int a);
...
private:
    ...
    void WriteChar(int row, int col, char c, int a);
    void WriteCharAt(int x, int y, char c, int a);
